...
export const AI_MODELS = {
  CONSULTANT: "gemini-2.5-flash-lite",
  CURRICULUM: "gemini-2.5-flash-lite",
  CONTENT: "gemini-2.5-flash-lite",
  CHAT: "gemini-2.0-flash-lite",
  IMAGE_ANALYSIS: "gemini-2.0-flash-lite",
  ANSWER_EVAL: "gemini-2.0-flash-lite",
  TTS: "gemini-2.5-flash-preview-tts",
  LIVE_VOICE: "gemini-2.5-flash-native-audio-preview-09-2025",
} as const;
...
export const IMAGE_CONFIG = {
  ...
  WIKIMEDIA_FETCH_COUNT: 3,          // Images to fetch from Wikimedia
